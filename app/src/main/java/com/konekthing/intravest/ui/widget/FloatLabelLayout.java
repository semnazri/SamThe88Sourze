...
public class FloatLabelLayout extends LinearLayout {
    ...
    private static final float DEFAULT_LABEL_PADDING_LEFT = 4f;
    private static final float DEFAULT_LABEL_PADDING_TOP = 0f;
    private static final float DEFAULT_LABEL_PADDING_RIGHT = 4f;
    private static final float DEFAULT_LABEL_PADDING_BOTTOM = 0f;

    private EditText mEditText;
    private TextView mLabel;

    private CharSequence mHint, mEditTextHint;
    private Interpolator mInterpolator;
    private boolean mAlwaysShow;
    private boolean mHintSet;
    ...
    public FloatLabelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mAlwaysShow = a.getBoolean(R.styleable.FloatLabelLayout_floatLabelAlwaysShow,
                false);
    ...
    private void setEditText(EditText editText) {
        ...
        mEditTextHint = mEditText.getHint();
            ...
            ViewCompat.animate(mLabel)
                    ...
                    .setListener(new ViewPropertyAnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(View view) {
                            mLabel.setVisibility(INVISIBLE);
                            mEditText.setHint(mHintSet ? mEditTextHint : mHint);
                        }
                    })
                    .setInterpolator(mInterpolator).start();
        } else {
